define(['text!../lib/lotofacil/loto-template.html','knockout', 'underscore', 'api'],
    ...
    var LotofacilViewModel = function(params) {
        ...
        self.lotofacilCurrentPrize = ko.pureComputed(function() {
            if (!self.currentBet() || !self.currentDraw() || !self.lotofacilHitsOk() || self.lotofacilHitsOk() < MIN_HITS_TO_PRIZE)
                return "0,00";

            var idx = AMOUNT - self.lotofacilHitsOk();
